...
Module DataModule
    ...
    Public Function GetAllPembalap() As DataTable
        ...
        Try
            Dim query As String =
            "SELECT p.id, p.nama, p.negara, p.nomor, p.foto, " &
    ...
    Public Function SearchPembalap(keyword As String) As DataTable
        ...
        Try
            ...
            "FROM TabelPembalap p " &
            "INNER JOIN TabelTim t ON p.idTim = t.id " &
            "WHERE p.nama LIKE @kw " &
            "OR p.negara LIKE @kw " &
            "OR p.nomor LIKE @kw " &
            "OR t.namaTim LIKE @kw " &
            "ORDER BY p.id ASC"
    ...
    Public Function SimpanPembalap(
    nama As String,
    negara As String,
    nomor As Integer,
    foto As String,
    idTim As Integer) As Boolean
        ...
        Try
            ...
            "VALUES (@nama, @negara, @nomor, @foto, @idTim)"
    ...
    Public Function GetAllTim() As DataTable
        ...
        Try
            ...
            Dim query As String =
            "SELECT id, namaTim, negara, mesin, chasis, logo " &
            "FROM TabelTim " &
            "ORDER BY id ASC"
    ...
    logo As String) As Boolean
        ...
        Try
            ...
            "VALUES (@namaTim, @negara, @mesin, @chasis, @logo)"
    ...
    Public Function CekPembalapSudahAdaDiRace(
    idRace As Integer,
    idPembalap As Integer) As Boolean
