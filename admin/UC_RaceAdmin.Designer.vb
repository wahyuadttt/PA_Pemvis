...
Partial Class UC_RaceAdmin
    ...
    Private Sub InitializeComponent()
        ...
        DataGridView2.AlternatingRowsDefaultCellStyle = DataGridViewCellStyle7
        ...
        ' DataGridView1
        ' 
        DataGridViewCellStyle10.BackColor = Color.FromArgb(CByte(38), CByte(38), CByte(52))
        ...
        DataGridViewCellStyle11.BackColor = Color.FromArgb(CByte(15), CByte(15), CByte(20))
        DataGridViewCellStyle11.Font = New Font("Segoe UI", 9F, FontStyle.Bold)
        DataGridViewCellStyle11.ForeColor = Color.White
        DataGridViewCellStyle11.SelectionBackColor = Color.FromArgb(CByte(15), CByte(15), CByte(20))
        ...
        DataGridViewCellStyle12.BackColor = Color.FromArgb(CByte(30), CByte(30), CByte(40))
        DataGridViewCellStyle12.Font = New Font("Segoe UI", 9F)
        DataGridViewCellStyle12.ForeColor = Color.White
        DataGridViewCellStyle12.Padding = New Padding(4)
        DataGridViewCellStyle12.SelectionBackColor = Color.FromArgb(CByte(225), CByte(6), CByte(0))
